...
url = "https://www.pecangrovefuneral.com"
print(f"Testing Pecan Grove Funeral Home: {url}")
        ...
        try:
            ...
            if test_response.status_code == 200:
                ...
                if individual_obits:
                    ...
                    # Test one
                    test_obit = individual_obits[0]
                    obit_response = requests.get(test_obit, headers=headers)
                    print(f"    Testing {test_obit} -> {obit_response.status_code}")
