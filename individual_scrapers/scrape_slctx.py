#!/usr/bin/env python3
"""
Individual Scraper for SLC Texas
Focused scraper for https://www.slctx.com
"""
...
class SLCTexasScraper:
    def __init__(self):
        self.base_url = "https://www.slctx.com"
        self.funeral_home_name = "SLC Texas"
        self.output_file = Path(__file__).parent.parent / "obituaries_slctx.json"
