#!/usr/bin/env python3
"""
Individual Scraper for Foss Funeral Home
Focused scraper for https://www.fossfuneralhome.com
"""
...
class FossFuneralHomeScraper:
    def __init__(self):
        self.base_url = "https://www.fossfuneralhome.com"
        self.funeral_home_name = "Foss Funeral Home"
        self.output_file = Path(__file__).parent.parent / "obituaries_fossfuneralhome.json"
    ...
    def find_obituary_listings(self):
        ...
        # For Foss, obituaries are directly on the homepage
        print(f"  ✅ Using homepage (obituaries displayed there): {self.base_url}")
...
if __name__ == "__main__":
    scraper = FossFuneralHomeScraper()
    scraper.run()
