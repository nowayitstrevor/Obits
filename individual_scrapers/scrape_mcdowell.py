#!/usr/bin/env python3
"""
Individual Scraper for McDowell Funeral Home
Focused scraper for https://www.mcdowellfuneralhome.com
"""
...
class McDowellFuneralHomeScraper:
    def __init__(self):
        self.base_url = "https://www.mcdowellfuneralhome.com"
        self.funeral_home_name = "McDowell Funeral Home"
        self.output_file = Path(__file__).parent.parent / "obituaries_mcdowellfuneralhome.json"
...
if __name__ == "__main__":
    scraper = McDowellFuneralHomeScraper()
    scraper.run()
